...
class MemoryStore:
    """Vector memory real con almacenamiento en PostgreSQL.

    Implementacion:
    - Genera embeddings por OpenAI u Ollama.
    - Guarda en tablas por dominio (`mem_finance.memory_vectors`, `mem_tech.memory_vectors`).
    - Recupera contexto por similitud coseno usando operador pgvector `<=>`.
    """
